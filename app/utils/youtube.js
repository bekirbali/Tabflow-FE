...
export function getInitialSeedVideos() {
  return [
    ...
    },
    {
      ...
      metadata: {
        description: "A walk through my complete design workflow, starting from wireframes in Figma to responsive code.",
        read_time: "8 dk okuma"
      }
    },
    {
    ...
    },
    {
      ...
      duration: "12:15",
      curator: "@feed_master",
      is_clean: true, // Marked as clean initially to populate Archive
      liked: false,
      bookmarked: false,
    ...
    // backward compat mapper fields
    seed.is_watched = seed.is_clean;
    seed.author_name = seed.source_name;
    if (seed.type === "video") {
      seed.videoId = seed.video_id;
    }
    return seed;
  });
}
